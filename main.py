...
wiki_wiki = wikipediaapi.Wikipedia(
    language='en',
    user_agent='MyChatbot/1.0 (Contact: your_email@example.com)'
)
...
# -- Return to Main Menu (Ramesh Kumar) --
...
# ----- Retrieve Summary of Wikipedia Article (Ramesh Kumar) -----
def wiki_article_validate(articlename):
    ...
    if page_py.exists() == True:
        ...
        )  # This line was done with assistance from 
        print(
